...
export default function Creds(){
    return(
        <div className="flex min-h-screen w-full">
            ...
            <div className="m-auto flex flex-col bg-stone-700 h-[90%] w-11/12 max-w-none py-10 lg:py-[3%] rounded-lg prose prose-invert prose-base lg:prose-lg">
                ...
                <h1 className="text-center px-5">Diffrence Between ... Fitha</h1>
